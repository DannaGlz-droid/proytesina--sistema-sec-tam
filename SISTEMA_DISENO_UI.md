...
- En Columnas de Distritos, Top 10 conserva cada identificador y municipio completos en una sola línea con tipografía de 11 px cuando caben en el ancho real. En “Todos”, los 13 nombres conservan también 11 px y pueden ocupar hasta dos líneas para evitar que la gráfica se perciba reducida; no se gira el texto. En pantallas estrechas, las etiquetas se envuelven por palabras para evitar solapamientos.
...
- Las gráficas de pastel y dona priorizan comparaciones de pocas categorías. Su opción completa se denomina “Resumen (n)” cuando existen más de cinco: representa las cinco categorías con mayor valor y agrupa las demás en un único segmento neutral `Resto (n categorías)`, de modo que el total no se pierde ni se presentan decenas de sectores ilegibles. No se ofrece un Top 5 separado porque produciría la misma composición que el resumen. El control “Resumen (n)” y el segmento `Resto` ya comunican este comportamiento; no repetirlo mediante una nota auxiliar debajo de “Mostrar”. La paleta circular institucional es cualitativa y combina granate, dorado, azul, verde y terracota; el gris queda reservado para `Resto`, evitando una secuencia monocromática difícil de distinguir. Con hasta seis sectores y nombres breves, la leyenda se sustituye por llamadas exteriores: una línea guía discreta conecta cada sector con el nombre y el valor, porcentaje o ambos elegido en Presentación. No usar puntas de flecha ni duplicar esa información en una leyenda. En pantallas estrechas o con nombres extensos, conservar una leyenda alineada por nombre y métrica; `Resto` se presenta en tono neutral y cursiva. En escritorio, la leyenda vertical se mantiene próxima al círculo sin invadirlo. Cuando se selecciona “Sin etiquetas”, la leyenda queda más angosta: recentrar ópticamente el conjunto pastel–leyenda, separar ambos bloques entre 32 y 40 px y reducir el círculo aproximadamente 5 % para que no parezca adherido a la leyenda. El diámetro exterior y el grosor del anillo permanecen estables y solo se reducen de forma responsiva cuando el ancho o alto disponible realmente lo exige. La exportación de Pastel y Dona recorta el lienzo según los límites reales del círculo, las llamadas o la leyenda, con una composición horizontal compacta y margen uniforme.
