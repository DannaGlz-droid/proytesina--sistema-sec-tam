...
- “Periodo predeterminado” representa la ventana automática de los últimos doce meses; “Todas las fechas” es una elección explícita distinta y no debe activar esa ventana. Los años aceptan un año, listas o intervalos; los meses no seleccionados dentro de un intervalo no se incluyen implícitamente. Los periodos personalizados, trimestres y edades se validan antes de aplicar y muestran el error junto al control correspondiente.
...
- Comparativa ofrece “Mapa de calor” para cruces matriciales. Las columnas representan la segunda dimensión y las filas la primera; cada celda conserva el conteo real y el porcentaje sobre el total analizado. “Distrito de residencia frente a distrito de defunción” cruza explícitamente ambos campos y exige los dos como datos completos. La vista reutiliza el mismo límite Top que la comparativa de columnas cuando la segunda dimensión es extensa.
