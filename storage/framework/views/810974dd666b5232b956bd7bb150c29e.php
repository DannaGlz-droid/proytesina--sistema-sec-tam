...
<div class="flex flex-col sm:flex-row justify-end gap-3 lg:gap-4" <?php echo e($attributes); ?>>
    ...
    <?php if($secondaryHref): ?>
        <a href="<?php echo e($secondaryHref); ?>" class="border border-[#404041] text-[#404041] px-4 lg:px-6 py-2 rounded-lg text-xs lg:text-sm font-semibold hover:bg-gray-50 transition-all duration-300 font-lora flex items-center justify-center gap-1 whitespace-nowrap">
    ...
    <?php elseif($secondaryText && !request()->is('reportes/*/*/edit')): ?>
        <button type="<?php echo e($secondaryType); ?>" 
                ...
                class="border border-[#404041] text-[#404041] px-4 lg:px-6 py-2 rounded-lg text-xs lg:text-sm font-semibold hover:bg-gray-50 transition-all duration-300 font-lora flex items-center justify-center gap-1 whitespace-nowrap">
            <?php if($secondaryIcon): ?>
                <i class="fas <?php echo e($secondaryIcon); ?> text-xs"></i>
            <?php endif; ?>
            <?php echo e($secondaryText); ?>
    ...
    <?php if($tertiaryText): ?>
        <?php if($tertiaryHref): ?>
            <a href="<?php echo e($tertiaryHref); ?>" class="border border-[#404041] text-[#404041] px-4 lg:px-6 py-2 rounded-lg text-xs lg:text-sm font-semibold hover:bg-gray-50 transition-all duration-300 font-lora flex items-center justify-center gap-1 whitespace-nowrap">
    ...
    <button type="<?php echo e($primaryType); ?>" 
            class="bg-[#611132] text-white px-4 lg:px-6 py-2 rounded-lg text-xs lg:text-sm font-semibold hover:bg-[#4a0e26] transition-all duration-300 font-lora flex items-center justify-center gap-1 whitespace-nowrap">
        <?php if($primaryIcon): ?>
