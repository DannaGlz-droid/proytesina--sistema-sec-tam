...
<div <?php echo e($attributes->merge(['class' => 'border border-[#404041] rounded-lg p-5 bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg group flex flex-col h-full relative publication-card'])); ?>>
    <div class="flex-grow min-w-0">
        <div class="flex justify-between items-start mb-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php if($status === 'aprobado'): ?>
                    <div class="w-6 h-6 flex items-center justify-center rounded-full bg-green-100 text-green-700 cursor-help hover:bg-green-200 transition-colors duration-200" title="Aprobado por: <?php echo e($approvedBy); ?>">
                        <i class="fas fa-check-circle text-sm"></i>
                    </div>
                <?php elseif($status === 'rechazado'): ?>
                    <div class="w-6 h-6 flex items-center justify-center rounded-full bg-red-100 text-red-700 cursor-help hover:bg-red-200 transition-colors duration-200" title="Rechazado por: <?php echo e($rejectedBy); ?>">
        ...
        <h3 class="text-lg font-semibold text-[#404041] mb-3 leading-tight font-lora truncate" title="<?php echo e($titulo); ?>"><?php echo e($titulo); ?></h3>
            ...
            <div class="bg-gray-50 p-4 rounded-lg border border-[#404041] cursor-pointer transition-all duration-300 hover:bg-gray-100 archivos-open">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 flex items-center justify-center rounded-lg bg-[#BC955C] text-white">
                        <i class="fas <?php echo e($iconoClase); ?> text-sm"></i>
                    </div>
