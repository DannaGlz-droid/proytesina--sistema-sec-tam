    ...
    <div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="mb-6">
                    <a href="<?php echo e(route('user.index')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center gap-2">
                ...
                <form method="POST" action="<?php echo e(route('user.store')); ?>" id="userForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $jurisdictions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurisdiction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($jurisdiction->id); ?>" <?php echo e(old('jurisdiction_id') == $jurisdiction->id ? 'selected' : ''); ?>>
                                        <?php echo e($jurisdiction->name); ?>
...
</html><?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views\usuarios\create.blade.php ENDPATH**/ ?>