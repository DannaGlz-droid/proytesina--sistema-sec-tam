                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <table id="users-table" class="min-w-full w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                ...
                                <button id="bulk-delete-users" type="button" class="h-8 px-3 bg-red-600 text-white rounded-lg text-xs font-semibold hover:bg-red-700 transition-all duration-150" title="Eliminar seleccionados" style="display:none; margin: 8px;">
