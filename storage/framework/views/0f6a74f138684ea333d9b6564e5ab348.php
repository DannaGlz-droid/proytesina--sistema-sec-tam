                ...
                <!-- Mantener solo una versión del grid principal; la versión final aparece más abajo. -->
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 lg:gap-4 items-start">
                        ...
                        <div>
                            ...
                            <input id="gov_folio" name="gov_folio" type="text" value="<?php echo e(old('gov_folio')); ?>" required minlength="9" maxlength="9" pattern="[0-9]{9}" inputmode="numeric" title="Debe ingresar exactamente 9 dígitos numéricos"
