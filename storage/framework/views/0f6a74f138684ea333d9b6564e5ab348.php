...
<?php $__env->startSection('title', 'Nuevo Registro'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="px-4 lg:pl-10 pt-6 lg:pt-10 pb-8 lg:pb-12">
        ...
        <div class="border border-[#404041] rounded-lg lg:rounded-xl p-4 lg:p-6 bg-white bg-opacity-95 max-w-7xl shadow-md">
            <form id="death-register-form" method="POST" action="<?php echo e(route('statistic.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <!-- Mantener solo una versión del grid principal; la versión final aparece más abajo. -->
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 lg:gap-4 items-start">
                        ...
                        <div>
                            ...
                            <input id="gov_folio" name="gov_folio" type="text" value="<?php echo e(old('gov_folio')); ?>" required minlength="9" maxlength="17" pattern="([0-9]{9}|[0-9]{2}[A-Za-z][0-9]{5}[A-Za-z][0-9]{8})" title="Debe ingresar 9 dígitos o el folio alfanumérico de defunción"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input name="name" type="text" value="<?php echo e(old('name')); ?>" required minlength="2" maxlength="191"
                                   class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input name="first_last_name" type="text" value="<?php echo e(old('first_last_name')); ?>" required minlength="2" maxlength="191"
                                   class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora" 
                                   placeholder="Ej: Nava">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input name="second_last_name" type="text" value="<?php echo e(old('second_last_name')); ?>" minlength="2" maxlength="191"
                                   class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="sex" required class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora">
                                ...
                                <option value="masculino" <?php echo e(old('sex') === 'masculino' ? 'selected' : ''); ?>>Masculino</option>
                                <option value="femenino" <?php echo e(old('sex') === 'femenino' ? 'selected' : ''); ?>>Femenino</option>
                            </select>
                            <?php $__errorArgs = ['sex'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input id="edad_valor" name="edad_valor" type="number" min="0" max="150" value="<?php echo e(old('edad_valor')); ?>" required
                                ...
                                <select id="edad_unidad" name="edad_unidad" required class="w-1/2 px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora">
                                    ...
                                    <option value="anos" <?php echo e(old('edad_unidad') === 'anos' ? 'selected' : ''); ?>>Años</option>
                                    <option value="meses" <?php echo e(old('edad_unidad') === 'meses' ? 'selected' : ''); ?>>Meses</option>
                                    <option value="dias" <?php echo e(old('edad_unidad') === 'dias' ? 'selected' : ''); ?>>Días</option>
                                </select>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-4">
                        ...
                        <div>
                            ...
                            <select id="residence_municipality_select" name="residence_municipality_id" required class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora tomselect-select">
                                ...
                                <?php if(old('residence_municipality_id')): ?>
                                    <?php $m = $municipalities->firstWhere('id', old('residence_municipality_id')) ?>
                                    <?php if($m): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="death_municipality_select" name="death_municipality_id" required class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora tomselect-select">
                                <option value="">Seleccione un municipio</option>
                                <?php if(old('death_municipality_id')): ?>
                                    <?php $m2 = $municipalities->firstWhere('id', old('death_municipality_id')) ?>
                                    <?php if($m2): ?>
                                        <option value="<?php echo e($m2->id); ?>" selected><?php echo e($m2->name); ?></option>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </select>
                        ...
                        <div>
                            ...
                            <select id="death_municipality_location" name="death_location_id" required class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora">
                                ...
                                <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($loc->id); ?>" <?php echo e(old('death_location_id') == $loc->id ? 'selected' : ''); ?>><?php echo e($loc->name); ?></option>
                        ...
                        <div>
                            ...
                            <select id="death_cause" name="death_cause_id" required class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora">
                                ...
                                <?php $__currentLoopData = $causes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>" <?php echo e(old('death_cause_id') == $c->id ? 'selected' : ''); ?>><?php echo e($c->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input name="death_date" type="date" value="<?php echo e(old('death_date')); ?>" required
                                   class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-buttons','data' => ['secondaryOnclick' => 'clearDeathForm(event)','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('statistic.data')).'','primaryText' => 'Guardar registro']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['secondaryOnclick' => 'clearDeathForm(event)','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('statistic.data')).'','primaryText' => 'Guardar registro']); ?>
...
<?php endif; ?>
    ...
    <script>
            ...
            window.clearDeathForm = function(e) {
                ...
                window.location.href = "<?php echo e(route('statistic.create')); ?>";
            }
        });
