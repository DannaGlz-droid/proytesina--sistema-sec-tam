                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <input id="jurisdiction_display_gv" type="text" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora" value="<?php echo e(isset($report) && $report->jurisdiction ? $report->jurisdiction->name : 'Pendiente (seleccione municipio)'); ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
