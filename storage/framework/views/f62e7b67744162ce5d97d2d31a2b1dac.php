...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input id="second_last_name" name="second_last_name" type="text" minlength="2" maxlength="191"
                                ...
                                value="<?php echo e(old('second_last_name', $user->second_last_name)); ?>">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input id="first_last_name" name="first_last_name" type="text" required minlength="2" maxlength="191"
                                ...
                                value="<?php echo e(old('first_last_name', $user->first_last_name)); ?>">
                            ...
                            <select id="position_select" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora tomselect-select" name="position_id">
                                ...
                                <?php if(isset($positions)): ?>
                                    <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->id); ?>" <?php echo e(old('position_id', $user->position_id) == $p->id ? 'selected' : ''); ?>><?php echo e($p->name); ?></option>
                        ...
                        <div>
                            ...
                            <select id="district_id" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora tomselect-select" name="district_id" required>
                                ...
                                <?php if(isset($districts)): ?>
                                    <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($j->id); ?>" <?php echo e(old('district_id', $user->district_id) == $j->id ? 'selected' : ''); ?>><?php echo e($j->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="pt-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="ml-3 text-sm font-medium text-[#404041] font-lora" id="toggleLabel">
                                    <?php echo e((old('is_active', $user->is_active ?? 1) == 1) ? 'Activo' : 'Inactivo'); ?>
                            ...
                            <select id="role_id" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora" name="role_id" required>
                                ...
                                <?php if(isset($roles)): ?>
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($r->id); ?>" <?php echo e(old('role_id', $user->role_id ?? '') == $r->id ? 'selected' : ''); ?>><?php echo e($r->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            <?php if($errors->any()): ?>
                const errors = <?php echo json_encode($errors->messages(), 15, 512) ?>;
            ...
            <div id="advertenciaInactivo" class="mb-6 p-4 border border-yellow-300 bg-yellow-50 rounded-lg <?php echo e((old('is_active', $user->is_active ?? 1) == 1) ? 'hidden' : ''); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-buttons','data' => ['primaryText' => 'Actualizar registro','secondaryText' => '','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('user.user-gestion')).'','primaryType' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['primaryText' => 'Actualizar registro','secondaryText' => '','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('user.user-gestion')).'','primaryType' => 'submit']); ?>
...
<?php echo $__env->make('layouts.principal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views/usuarios/acciones/actualizar-registro.blade.php ENDPATH**/ ?>