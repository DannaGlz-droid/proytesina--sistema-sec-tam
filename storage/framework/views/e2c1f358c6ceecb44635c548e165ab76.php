                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px; width:100%; background:#ffffff; border:1px solid #e5e7eb;">
                    <tr>
                        <td style="padding:24px; border-top:4px solid #611132;">
                            <h1 style="margin:0 0 12px; font-size:22px; color:#404041;"><?php echo e($notificationTitle); ?></h1>
                            <p style="margin:0 0 16px; font-size:15px; line-height:1.5;">
                                <?php echo e($notificationMessage); ?>

                            </p>

                            <p style="margin:0 0 6px; font-size:14px; font-weight:bold;">Reporte:</p>
                            <p style="margin:0 0 16px; font-size:14px; line-height:1.5;">
                                <?php echo e($publication->topic); ?>
                            ...
                            <a href="<?php echo e($reportUrl); ?>" style="display:inline-block; padding:10px 16px; background:#611132; color:#ffffff; text-decoration:none; font-size:14px; font-weight:bold;">
                                Ver comentario
                            </a>
                        </td>
                    </tr>
