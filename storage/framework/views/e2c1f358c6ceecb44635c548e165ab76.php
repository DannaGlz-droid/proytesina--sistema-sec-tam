                    ...
                    <tr>
                        <td style="padding:24px; border-top:4px solid #611132;">
                            ...
                            <p style="margin:0 0 18px; font-size:15px; line-height:1.55;">
                                <span style="font-style:italic; font-weight:600;"><?php echo e($senderFullName); ?></span>
                                <?php echo e($isReply ? 'respondió' : 'comentó'); ?> en
                                <span style="font-style:italic; font-weight:600;">“<?php echo e($publication->topic); ?>”</span>:
                            </p>
