...
<?php $__env->startSection('content'); ?>
    ...
    <div class="px-4 lg:pl-10 pt-6 lg:pt-10 pb-8 lg:pb-12">
        ...
        <form id="seguridadVialForm" action="<?php echo e(isset($publication) ? route('reportes.seguridad-vial.update', $publication) : route('reportes.seguridad-vial.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <?php if($isAdminOrCoordinator ?? false): ?>
                                ...
                                <select id="jurisdiction_select_vial" name="jurisdiccion" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora" placeholder="Seleccione un distrito" required>
                                    ...
                                    <?php if($selectedDistritoVial): ?>
                                        <?php $selectedDistrictModelVial = $districts->firstWhere('id', $selectedDistritoVial) ?>
                                        <?php if($selectedDistrictModelVial): ?>
                                            <option value="<?php echo e($selectedDistrictModelVial->id); ?>" selected><?php echo e($selectedDistrictModelVial->name); ?></option>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </select>
                            <?php else: ?>
                                <!-- Para Operadores: campo readonly con distrito pre-asignado -->
                                <input type="hidden" id="jurisdiction_input_vial" name="jurisdiccion" value="<?php echo e(old('jurisdiccion', isset($report) ? $report->district_id : '')); ?>" required>
                                <input id="jurisdiction_display_vial" type="text" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-200 rounded-lg bg-gray-50 text-gray-600 focus:ring-2 focus:ring-gray-300 focus:border-transparent transition-all duration-200 font-lora" value="<?php echo e(isset($report) && $report->district ? $report->district->name : 'Pendiente (seleccione municipio)'); ?>" readonly>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <textarea
                            ...
                            maxlength="5000"
                        ><?php echo e(old('descripcion', isset($publication) && $publication->description !== 'Sin descripción adicional.' ? $publication->description : '')); ?></textarea>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-buttons','data' => ['primaryText' => 'Actualizar registro','secondaryText' => '','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('reportes.index', ['tipo' => request('redirect_tipo', 'seguridad_vial')])).'','primaryType' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['primaryText' => 'Actualizar registro','secondaryText' => '','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('reportes.index', ['tipo' => request('redirect_tipo', 'seguridad_vial')])).'','primaryType' => 'submit']); ?>
...
<?php endif; ?>
            <?php else: ?>
                <?php if (isset($component)) { $__componentOriginal4472fe0a558b38a919fed94c8472a9fd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4472fe0a558b38a919fed94c8472a9fd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-buttons','data' => ['primaryText' => 'Guardar registro','secondaryText' => 'Limpiar formulario','primaryType' => 'submit','secondaryType' => 'button','secondaryOnclick' => 'clearSeguridadVialForm()','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('reportes.index', ['tipo' => request('redirect_tipo', 'seguridad_vial')])).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-buttons'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['primaryText' => 'Guardar registro','secondaryText' => 'Limpiar formulario','primaryType' => 'submit','secondaryType' => 'button','secondaryOnclick' => 'clearSeguridadVialForm()','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('reportes.index', ['tipo' => request('redirect_tipo', 'seguridad_vial')])).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4472fe0a558b38a919fed94c8472a9fd)): ?>
<?php $attributes = $__attributesOriginal4472fe0a558b38a919fed94c8472a9fd; ?>
...
<?php endif; ?>
        ...
        <input type="hidden" name="redirect_tipo" value="<?php echo e(request('redirect_tipo', 'seguridad_vial')); ?>">
        </form>
