    ...
    <div class="flex items-center">
        ...
        <div class="flex items-center space-x-2">
            ...
            <?php if(!auth()->user()->isGuest()): ?>
                <a href="<?php echo e(route('reportes.index')); ?>" class="text-base lg:text-base font-semibold hover:underline text-white py-1 lg:py-1 px-3 lg:px-4 rounded-md transition-all ease-in-out mr-3 lg:mr-4 inline-flex items-center justify-center whitespace-nowrap">
                    Reportes
                </a>
            <?php endif; ?>
            ...
            <?php if(auth()->user()->hasAnyRole(['Administrador', 'Coordinador'])): ?>
                <a href="<?php echo e(route('statistic.data')); ?>" class="text-base lg:text-base font-semibold hover:underline text-white py-1 lg:py-1 px-3 lg:px-4 rounded-md transition-all ease-in-out mr-3 lg:mr-4 inline-flex items-center justify-center whitespace-nowrap">
                    Estadísticas
                </a>
            <?php endif; ?>
        </div>
