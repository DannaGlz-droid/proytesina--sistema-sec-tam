    ...
    <div class="mb-6">
        ...
        <div class="datos-generales-grid grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div class="bg-white rounded-lg p-4 border border-[#404041]">
                ...
                <div class="dato-general-value text-base font-bold text-[#404041] font-lora modal-municipio">Municipio Centro</div>
            ...
            <div class="bg-white rounded-lg p-4 border border-[#404041]">
                ...
                <div class="dato-general-value text-base font-bold text-[#404041] font-lora modal-distrito">Distrito Sanitario III</div>
...
<?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views/components/modal-observatorio.blade.php ENDPATH**/ ?>