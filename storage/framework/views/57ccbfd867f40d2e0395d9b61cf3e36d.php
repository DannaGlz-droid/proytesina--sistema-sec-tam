        ...
        <tr>
            <td align="center">
                <table role="presentation" width="760" cellspacing="0" cellpadding="0" style="max-width:760px; width:100%; background:#ffffff; border:1px solid #e5e7eb;">
                    <tr>
                        <td style="padding:24px; border-top:4px solid #611132;">
                            ...
                            <h1 style="margin:0 0 14px; font-size:22px; color:#404041;">
                                <?php echo e($isReply ? 'Nueva respuesta' : 'Nuevo comentario en tu publicación'); ?>

                            </h1>
                            <p style="margin:0 0 18px; font-size:15px; line-height:1.55;">
                                <span style="font-weight:600; font-style:italic;"><?php echo e($senderFullName); ?></span>
                                <?php echo e($isReply ? 'respondió' : 'comentó'); ?> en
                                <span style="font-weight:600; font-style:italic;">“<?php echo e($publication->topic); ?>”</span>:
                            </p>
                            ...
                            <a href="<?php echo e($reportUrl); ?>" style="display:inline-block; padding:11px 18px; background:#611132; color:#ffffff; text-decoration:none; font-size:14px; font-weight:bold;">
                                Ver comentario
                            </a>
                        </td>
                    </tr>
                    ...
                    <?php echo $__env->make('emails.partials.privacy-notice', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </table>
            </td>
        </tr>
    </table>
...
<?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views\emails\reportes\comment.blade.php ENDPATH**/ ?>