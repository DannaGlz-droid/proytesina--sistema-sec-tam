...
<?php $__env->startSection('content'); ?>
    ...
    <div class="px-4 lg:pl-10 pt-6 lg:pt-10 pb-8 lg:pb-12">
        ...
        <div class="border border-[#404041] rounded-lg lg:rounded-xl p-4 lg:p-6 bg-white bg-opacity-95 max-w-7xl shadow-md">
            ...
            <form action="<?php echo e(route('user.store')); ?>" method="POST" id="userRegistroForm">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input id="second_last_name" name="second_last_name" type="text" minlength="2" maxlength="191"
                                        ...
                                        value="<?php echo e(old('second_last_name')); ?>">
                                </div>
                            </div>
                                    ...
                                    <select id="position_select" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora tomselect-select" name="position_id" required>
                                        ...
                                        <?php if(isset($positions)): ?>
                                            <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($p->id); ?>" <?php echo e(old('position_id') == $p->id ? 'selected' : ''); ?>><?php echo e($p->name); ?></option>
                                    ...
                                    <select id="district_id" class="w-full px-3 py-2 text-xs lg:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#404041] focus:border-transparent transition-all duration-200 font-lora tomselect-select" name="district_id" required>
                                        ...
                                        <?php if(isset($districts)): ?>
                                            <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($j->id); ?>" <?php echo e(old('district_id') == $j->id ? 'selected' : ''); ?>><?php echo e($j->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-buttons','data' => ['primaryText' => 'Guardar registro','secondaryText' => 'Limpiar formulario','secondaryOnclick' => 'clearRegistroForm(event)','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('user.user-gestion')).'','primaryType' => 'submit','secondaryType' => 'button']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['primaryText' => 'Guardar registro','secondaryText' => 'Limpiar formulario','secondaryOnclick' => 'clearRegistroForm(event)','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('user.user-gestion')).'','primaryType' => 'submit','secondaryType' => 'button']); ?>
...
<?php echo $__env->make('layouts.principal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views\usuarios\acciones\registro.blade.php ENDPATH**/ ?>