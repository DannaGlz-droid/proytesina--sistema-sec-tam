            ...
            <div class="flex justify-between items-start mb-2">
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-1">
                        <h2 class="text-xl font-lora font-bold text-[#404041] modal-titulo" title="<?php echo e($titulo); ?>" style="display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; word-break:break-word; overflow-wrap:break-word;"><?php echo e($titulo); ?></h2>
