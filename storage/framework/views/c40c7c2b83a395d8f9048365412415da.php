...
<div id="<?php echo e($modalId); ?>" class="fixed inset-0 bg-gray-900 bg-opacity-40 flex items-center justify-center z-[999999] hidden transition-opacity duration-200">
    <div class="publication-detail-modal bg-white rounded-xl max-w-4xl w-full mx-4 max-h-[95vh] overflow-hidden transform transition-all duration-300 scale-95 opacity-0 border border-gray-200 ring-1 ring-black/5 flex flex-col">
        ...
        <div class="px-5 py-2.5 min-h-[58px] border-b border-gray-300 flex-shrink-0 flex items-center">
            <div class="flex justify-between items-center gap-4 w-full">
                <div class="flex-1 overflow-hidden">
                    <h2 class="text-lg font-lora font-bold text-[#404041] modal-titulo" title="<?php echo e($titulo); ?>"><?php echo e($titulo); ?></h2>
        ...
        <div class="<?php echo e($colorBadge); ?> h-1.5 flex-shrink-0" aria-label="<?php echo e(ucwords(str_replace('_', ' ', $tipo))); ?>"></div>
