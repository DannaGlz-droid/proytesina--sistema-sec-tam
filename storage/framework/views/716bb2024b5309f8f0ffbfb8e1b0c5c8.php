...
<?php $__env->startSection('title', 'Actualizar Contraseña'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="px-4 lg:pl-10 pt-6 lg:pt-10 pb-8 lg:pb-12">
            ...
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-sm lg:text-base font-medium text-[#404041] font-lora">
                        Usuario: <?php echo e($user->name); ?> <?php echo e($user->first_last_name); ?> <?php echo e($user->second_last_name); ?>

                    </h3>
                    <p class="text-xs text-gray-600 mt-1 font-lora">
                        Correo: <?php echo e($user->email); ?> | 
                        Usuario: <?php echo e($user->username); ?>
        ...
        <div class="border border-[#404041] rounded-lg lg:rounded-xl p-4 lg:p-6 bg-white bg-opacity-95 max-w-7xl shadow-md">
            ...
            <!-- Sección: Contraseña -->
            <form action="<?php echo e(route('user.update-password.update', $user->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-buttons','data' => ['primaryText' => 'Actualizar contraseña','secondaryText' => '','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('user.user-gestion')).'','primaryType' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['primaryText' => 'Actualizar contraseña','secondaryText' => '','tertiaryText' => 'Volver al listado','tertiaryHref' => ''.e(route('user.user-gestion')).'','primaryType' => 'submit']); ?>
...
<?php echo $__env->make('layouts.principal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views\usuarios\acciones\actualizar-contrasena.blade.php ENDPATH**/ ?>