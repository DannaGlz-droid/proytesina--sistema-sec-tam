...
unset($__errorArgs, $__bag); ?>
        ...
        <select name="district_id">
            ...
            <?php $__currentLoopData = $jurisdictions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurisdiction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($jurisdiction->id); ?>" <?php echo e($user->district_id == $jurisdiction->id ? 'selected' : ''); ?>><?php echo e($jurisdiction->name); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
...
<?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views\usuarios\edit.blade.php ENDPATH**/ ?>