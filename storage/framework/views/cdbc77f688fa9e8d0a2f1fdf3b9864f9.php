    ...
    <div class="excel-shell">
        <?php if (! ($embedded)): ?>
            <div class="topbar">
                ...
                <p class="file-name"><?php echo e($fileName); ?></p>
                <?php if(!empty($sheetName)): ?>
                    <span class="file-meta"><?php echo e($sheetName); ?></span>
                <?php endif; ?>
            </div>
        <?php endif; ?>
                        ...
                        <thead>
                            <tr>
                                ...
                                <?php $__currentLoopData = $columnLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $columnLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="column-header"><?php echo e($columnLabel); ?></th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowNumber => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th class="row-header"><?php echo e($rowNumber + 1); ?></th>
                                    <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td title="<?php echo e($cell); ?>" data-row="<?php echo e($rowNumber + 1); ?>" data-column="<?php echo e($loop->iteration); ?>"><?php echo e($cell); ?></td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
        ...
        <div id="sheet-tabs" class="tabs-bar">
            <?php $__empty_1 = true; $__currentLoopData = $sheetNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a
                    href="<?php echo e(request()->fullUrlWithQuery(['sheet' => $index])); ?>"
                    class="sheet-tab <?php echo e($index === $activeSheetIndex ? 'active' : ''); ?>"
            ...
            <?php if(!empty($rowLimitReached) || !empty($columnLimitReached)): ?>
...
<?php /**PATH C:\Proyectos Laravel\sistema-sec-tam\resources\views/reportes/preview-excel.blade.php ENDPATH**/ ?>