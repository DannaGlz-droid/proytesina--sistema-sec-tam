...
class BreathalyzerReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'distrito' => 'required|integer|exists:districts,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'municipio.integer' => 'El municipio debe ser válido.',
            'municipio.exists' => 'El municipio seleccionado no existe.',
            'distrito.required' => 'El distrito es obligatorio.',
            'distrito.integer' => 'El distrito debe ser válido.',
            'distrito.exists' => 'El distrito seleccionado no existe.',
