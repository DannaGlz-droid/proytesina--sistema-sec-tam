                    ...
                    <div>
                        ...
                        <select id="residence_municipality_select" name="residence_municipality_id" class="tomselect-select" required
                            ...
                            @foreach($municipalities as $municipality)
                                <option value="{{ $municipality->id }}" @selected((string) old('residence_municipality_id') === (string) $municipality->id)>{{ $municipality->display_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select id="death_municipality_location" name="death_location_id" class="tomselect-select" required
                            ...
                            @foreach($locations as $location)
                                <option value="{{ $location->id }}" @selected((string) old('death_location_id') === (string) $location->id)>{{ $location->display_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select id="death_cause" name="death_cause_id" class="tomselect-select" required
                            ...
                            @foreach($causes as $cause)
                                <option value="{{ $cause->id }}" @selected((string) old('death_cause_id') === (string) $cause->id)>{{ $cause->display_name }}</option>
                            @endforeach
                        </select>
