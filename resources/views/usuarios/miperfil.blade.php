                    ...
                    <div class="flex flex-col items-center mb-6">
                        <div class="relative group">
                            @if(auth()->user()->profile_photo_path)
                                <img src="{{ asset('storage/' . auth()->user()->profile_photo_path) }}" alt="Foto de perfil" class="w-24 h-24 rounded-full object-cover border-4 border-[#611132]">
                            @else
                                <img src="{{ asset('images/default_pfp.svg.png') }}" alt="Avatar predeterminado" class="w-24 h-24 rounded-full object-cover border-4 border-[#611132]">
                            @endif
                        ...
                        <h2 class="text-lg font-lora font-bold text-[#404041] text-center mt-4">{{ $fullName ?? auth()->user()->name }}</h2>
