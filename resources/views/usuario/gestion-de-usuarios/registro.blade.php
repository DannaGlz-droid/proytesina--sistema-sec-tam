        ...
        <div class="border border-[#404041] rounded-lg lg:rounded-xl p-4 lg:p-6 bg-white bg-opacity-95 max-w-7xl shadow-md">
            ...
            <div class="mb-6 lg:mb-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-4">
                    ...
                    <div class="space-y-3">
                        <div>
                            <label class="block text-xs lg:text-sm font-medium text-[#404041] mb-1">Contraseña *</label>
                            <div class="relative">
                                <input type="password" 
                                       id="password"
                ...
                <div class="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    <!-- Indicador de fortaleza de contraseña - Ahora arriba de los requisitos -->
                    <div class="mb-3">
                    ...
                    <!-- Botón para generar contraseña - Ahora a la derecha y abajo -->
