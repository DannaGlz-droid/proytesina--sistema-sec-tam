      ...
      <div class="login-card relative w-full max-w-md overflow-hidden rounded-2xl border border-white/20 bg-white shadow-2xl">
        <section class="bg-white p-6 sm:p-8">
          ...
          <div class="mx-auto max-w-md">
            ...
            <form method="POST" action="{{ route('login') }}" class="login-form space-y-5">
              @csrf
              ...
              <div class="login-field">
                <div class="login-password-heading mb-2 flex items-center justify-between">
                  ...
                  @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-xs font-semibold text-[#611132] hover:underline">
              ...
              <div class="login-options flex items-center justify-between gap-4">
                <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                  <input type="checkbox" name="remember" value="1" {{ old('remember') ? 'checked' : '' }} class="rounded border-gray-300 text-[#611132] focus:ring-[#611132]">
                  Recordarme
                </label>
