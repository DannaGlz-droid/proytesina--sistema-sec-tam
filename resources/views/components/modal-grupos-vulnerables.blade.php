<x-modal-reporte-base tipo="grupos_vulnerables" titulo="Reporte de Grupos Vulnerables" modal-id="modalGruposVulnerables">
    <section class="report-section">
        <h3 class="report-section-title"><span>Datos generales</span></h3>
        <dl class="report-field-grid report-field-grid--three report-general-grid">
