<div class="bg-header text-white p-2 lg:p-3 w-full h-14 lg:h-16 font-sans flex items-center justify-between">
    ...
    <div class="flex items-center">
        ...
        <div class="hidden lg:flex items-center">
            <button class="text-sm lg:text-base bg-header hover:bg-[#9B4D6E] text-white py-1 lg:py-1 px-3 lg:px-4 rounded-md transition duration-200 ease-in-out mr-3 lg:mr-4">
                Reportes
            </button>
            <button class="text-sm lg:text-base bg-header hover:bg-[#9B4D6E] text-white py-1 lg:py-1 px-3 lg:px-4 rounded-md transition duration-200 ease-in-out mr-3 lg:mr-4">
                Estadísticas
