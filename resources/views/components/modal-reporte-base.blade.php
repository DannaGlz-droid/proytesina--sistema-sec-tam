        ...
        <div class="px-6 py-4 border-b border-gray-300 flex-shrink-0">
            <div class="flex justify-between items-start mb-2">
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600 font-lora modal-fecha-publicacion">sábado, 14 de octubre de 2023</p>
                </div>
        ...
        <div class="px-6 py-2 border-b border-gray-300 flex-shrink-0">
            <div class="flex flex-col md:flex-row justify-between items-center gap-0">
                <div class="w-full md:w-auto">
                    <p class="text-gray-600 text-sm font-lora text-center md:text-left modal-fecha-actividad">Fecha de la actividad: 8 de noviembre de 2023</p>
                </div>
                <div class="w-full md:w-auto">
                    <p class="text-sm text-gray-600 font-lora text-center md:text-right">Subido por: <span class="modal-usuario font-semibold">Usuario</span></p>
                </div>
            </div>
        </div>
