                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            @else
                                ...
                                <input type="hidden" id="jurisdiction_input" name="distrito" value="{{ old('distrito', isset($report) ? $report->district_id : '') }}" required>
